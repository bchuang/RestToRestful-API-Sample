...
namespace TestWebAPI
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        // Each operation be assigned one or more tags which are then used by
                        // consumers for various reasons. For example, the swagger-ui groups
                        // operations according to the first tag of each operation. By default, this
                        // will be controller name but you can use the "GroupActionsBy" option to
        ...
        {
            return System.String.Format(@"{0}\bin\XmlDocument.xml",
                System.AppDomain.CurrentDomain.BaseDirectory);
            //return  $"{System.AppDomain.CurrentDomain.BaseDirectory}\bin\XmlDocument.xml";
        }
    }
}